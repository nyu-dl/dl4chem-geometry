...
parser.add_argument('--npe-steps', type=int, default=1, help='number of mpnn steps')
...
model = MPNN.Model(data, n_max, dim_node, dim_edge, dim_h, dim_f, batch_size,\
                    args.dec, mpnn_steps=args.mpnn_steps, npe_steps=args.npe_steps, alignment_type=args.alignment_type)
